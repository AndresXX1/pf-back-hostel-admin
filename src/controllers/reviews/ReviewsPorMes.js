...
const getReviewStatisticsMes = async (req, res) => {
    try {
        ...
        const monthStats = await getReviewStatisticsForMonth(firstDayOfMonth, lastDayOfMonth);
        ...
        return res.status(404).json({ message: "No se encontraron estadísticas de reviews para este mes." });
